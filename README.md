...
###### ![Swift](https://img.shields.io/badge/Version-2.6.0-bright%20green)![Swift](https://img.shields.io/badge/platform-iOS-orange)
...
```swift
dependencies: [
    .package(url: "https://github.com/fbdlrghks123/KakaoSDK_SPM.git", .upToNextMajor(from: "2.6.0"))
]
```
