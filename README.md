...
###### ![Swift](https://img.shields.io/badge/Version-2.8.1-bright%20green)![Swift](https://img.shields.io/badge/platform-iOS-orange)
...
```swift
dependencies: [
    .package(url: "https://github.com/fbdlrghks123/KakaoSDK_SPM.git", .upToNextMajor(from: "2.8.1"))
]
```
